  ...
  return (
			...
			<div className="sm:flex sm:items-center">
				<div className="sm:flex-auto">
					...
					<p className="mt-2 text-sm text-gray-700">После отправки заказа с вами свяжется менеджер</p>
				</div>
			</div>
			<div
						...
						{#each $prodInCart as { id, value, price, unit, img, quantity }, idx} */}
							<tr>
								...
								>
									...
									<dl className="font-normal lg:hidden">
										...
										<dd className="mt-1 truncate">
											<span
												className="inline-flex rounded-md bg-cyan-100 px-2 text-xs font-semibold leading-5 text-cyan-900"
											>
												Цена: xxx руб/xxx
											</span>
										</dd>
								...
								<td className="hidden px-3 py-4 text-sm text-gray-500 lg:table-cell ">
									<span
										className="inline-flex rounded-md bg-cyan-100 px-3 py-1 text-sm font-semibold leading-5 text-cyan-900"
									>
										xxx руб/xxx
									</span>
								</td>
