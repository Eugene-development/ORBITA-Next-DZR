	...
	return (
		<>
			{isClient && productsInCart.includes(productID) ? (
				<div				
					className="mt-3 flex w-full items-center justify-center rounded-md border border-transparent bg-cyan-700 px-8 py-1 text-base font-medium text-white  focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-gray-50"
				>
