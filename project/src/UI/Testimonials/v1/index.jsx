export default () => {
	return (
		<>
			<div className="ml-8 mt-16 text-center text-base font-display">
				<div>
			...
			<section className="my-14 bg-gray-800 font-display">
				<div className="md:grid md:grid-cols-2">
					<div className="py-12 px-12 md:flex md:flex-col md:border-r md:border-cyan-900 md:py-20 ">
					...
					<div className="border-t-2 py-12 px-12 md:border-t-0 md:border-l md:py-20 ">
						<div className="text-2xl text-gray-100 md:flex-shrink-0">
