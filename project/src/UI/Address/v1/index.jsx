			...
			<div className="mx-auto max-w-7xl px-6 lg:px-8">
				<div className="mx-auto max-w-2xl lg:mx-0">
					...
					<p className="mt-6 text-lg leading-8 text-gray-600">
						Для вашего удобства наши торговые подразделения расположены в разных частях
						города. На выезде со стороны Нижнего Новгорода с одной стороны и на
						строительном рынке "Ярмарка" с другой.
					</p>
				</div>
				<div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 text-base leading-7 sm:grid-cols-2 sm:gap-y-16 lg:mx-0 lg:max-w-none">
					<div>
						...
						<address className="border-l  border-gray-200 pl-6 pt-2 not-italic text-gray-600 text-sm">
							<p>
								Съезд с объездной дороги г. Дзержинска. Рядом с шинным центром Велс.
							</p>
							<div className="mt-12">
								<div className="flex">
					...
					<div>
						...
						<address className="border-l border-gray-200 pl-6 pt-2 not-italic text-gray-600 text-sm">
							<p>
								Территория строительного рынка "Ярмарка 41" Павильоны 33, 34, 35,
								41, 52, 53
							</p>
							<div className="mt-12">
								<div className="flex">
