      ...
      <div className="relative mx-auto max-w-2xl py-24 sm:py-32 lg:max-w-6xl">
        ...
        <figure className="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
          <div className="relative col-span-2 lg:col-start-1 lg:row-start-2">
            ...
            <blockquote className="text-base font-semibold leading-8 text-gray-900 sm:text-xl sm:leading-9">
              <p>
                База стройматериалов "Орбита-Строй" предлагает в сезоне 2023 года наилучшие предложения по ассортименту и ценам на строительные и отделочные материалы, а так же на напольные покрытия и метизную продукцию. Находится наш строительный интернет магазин на выезде из Дзержинска недалеко от Нижнего Новгорода. Если вас интересуют стройматериалы в Дзержинске, то мы ждём Вас на нашей базе!
              </p>
            </blockquote>
          </div>
          ...
          <figcaption className="text-base lg:col-start-1 lg:row-start-3">
            <div className="font-semibold text-gray-900">Сорокин Сергей Владимирович</div>
