				...
				<figure className="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
					<div className="relative col-span-2 lg:col-start-1 lg:row-start-2">
						...
						<blockquote className="text-base font-semibold leading-8 text-gray-900 sm:text-xl sm:leading-9">
							<p>
								База стройматериалов "Орбита-Строй" предлагает в сезоне 2023 года
								...
								продукцию. Находится наш строительный интернет магазин на выезде из
								Дзержинска недалеко от Нижнего Новгорода. Если вас интересуют
								стройматериалы в Дзержинске, то мы ждём Вас на нашей базе!
							</p>
						</blockquote>
					</div>
